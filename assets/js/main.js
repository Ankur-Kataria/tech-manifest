...
(function () {
  ...
  function isMobileNavMode() {
    return Boolean(menuToggle && window.getComputedStyle(menuToggle).display !== 'none');
  }
  ...
  if (heroHighlight) {
    ...
    heroHighlight.style.whiteSpace = 'nowrap';
    heroHighlight.style.minWidth = `${Math.max(text.length, 12)}ch`;
